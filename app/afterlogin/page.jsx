...
export default function HomeCamp() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const total = await fetchTotalCollected();
      const { campaigns, campaignCount, donationCount } =
        await fetchCampaigns();
      setTotalCollected(total);
      setCampaignData({ campaigns, campaignCount, donationCount });
    };

    fetchData();
  }, []);

  const { campaigns, campaignCount, donationCount } = campaignData;
            ...
            <div>
              <div className="gap-15 flex items-end">
                <div className="container">
                  <SectionTitle
                    title="Our Campaigns"
                    paragraph="DC Fund is a decentralized crowdfunding platform built on
